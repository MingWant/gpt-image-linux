...
UPSTREAM_USER_AGENT = os.getenv("UPSTREAM_USER_AGENT", "").strip()
UPSTREAM_ORIGIN = os.getenv("UPSTREAM_ORIGIN", "").strip()
UPSTREAM_REFERER = os.getenv("UPSTREAM_REFERER", "").strip()
UPSTREAM_EXTRA_HEADERS = os.getenv("UPSTREAM_EXTRA_HEADERS", "").strip()
